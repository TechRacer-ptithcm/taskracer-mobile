...
export const Post = ({content, fileAttachment, likeCount, createAt} : PostProps)=>{
    ...
    return (
        <View style = {{flexDirection: 'column', backgroundColor: BackgroundColor, padding:12}}>
            <View style = {{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Space space={12}/>
                <View>
                    <Title title={content} color={GrayColor} size={18} type={true} horizontalPadding={0} verticalPadding={0}/>
            ...
            <Image source={{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRAD3_KAeW4kjNRMwNl-buJSl4WFEeKlLKWQ&s'}} style = {{width: '100%', aspectRatio:1, borderRadius: 12}}/>
        </View>
    )
}